...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        #print('shape of self.weights_hidden_to_output is ' + str(self.weights_hidden_to_output.shape))
        #print('shape of hidden_error is ' + str(hidden_error.shape))       
        
        # TODO: Backpropagated error terms - Replace these values with your calculations.
        output_error_term = error
        #print('shape of hidden_outputs ) is ' + str(hidden_outputs.shape))     
        #print('shape of hidden_outputs * ( 1 - hidden_outputs ) is ' + str((hidden_outputs * ( 1 - hidden_outputs )).shape))
        #print('value of hidden_outputs is ' + str(hidden_outputs))
        #print('value of hidden_error is ' + str(hidden_error))
        hidden_outputs = hidden_outputs.reshape(self.hidden_nodes,self.output_nodes)
        hidden_error_term = hidden_error * hidden_outputs * ( 1 - hidden_outputs ) 
        #print('shape of hidden_error_term is ' + str(hidden_error_term.shape))
